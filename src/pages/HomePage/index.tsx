...
const HomePage = () => {
	...
	return (
		...
		>
			<section
				id={mainContentId}
				className='w-full flex flex-col items-center max-w-6xl mx-auto text-center lg:text-left lg:grid lg:grid-cols-2 self-end'
			>
				<div className='mb-20 lg:mb-0'>
					<h1 className='font-sans-cond uppercase mb-4'>
